...
public class Google_ProtocolBuffers_AbstractMessageLite_MyLib_GCPlayerCmd_MyLib_GCPlayerCmd_BuilderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Google.ProtocolBuffers.AbstractMessageLite<MyLib.GCPlayerCmd,MyLib.GCPlayerCmd.Builder>), typeof(System.Object), "AbstractMessageLite_MyLib_GCPlayerCmd_MyLib_GCPlayerCmd_Builder");
	...
	static int get_DefaultInstanceForType(IntPtr L)
	{
		...
		try
		{
			...
			Google.ProtocolBuffers.AbstractMessageLite<MyLib.GCPlayerCmd,MyLib.GCPlayerCmd.Builder> obj = (Google.ProtocolBuffers.AbstractMessageLite<MyLib.GCPlayerCmd,MyLib.GCPlayerCmd.Builder>)o;
