...
public class Google_ProtocolBuffers_AbstractBuilderLite_MyLib_CGPlayerCmd_MyLib_CGPlayerCmd_BuilderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>), typeof(System.Object), "AbstractBuilderLite_MyLib_CGPlayerCmd_MyLib_CGPlayerCmd_Builder");
	...
	static int Clear(IntPtr L)
	{
		try
		{
			...
			Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder> obj = (Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>)ToLua.CheckObject<Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>>(L, 1);
	...
	static int MergeFrom(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>.MergeFrom");
			}
		}
		catch (Exception e)
		{
	...
	static int MergeDelimitedFrom(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				MyLib.CGPlayerCmd.Builder o = obj.MergeDelimitedFrom(arg0);
				ToLua.PushSealed(L, o);
				return 1;
			}
			else if (count == 3)
			{
				...
				MyLib.CGPlayerCmd.Builder o = obj.MergeDelimitedFrom(arg0, arg1);
				ToLua.PushSealed(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>.MergeDelimitedFrom");
			}
		}
		catch (Exception e)
		{
	...
	static int get_IsInitialized(IntPtr L)
	{
		...
		try
		{
			...
			Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder> obj = (Google.ProtocolBuffers.AbstractBuilderLite<MyLib.CGPlayerCmd,MyLib.CGPlayerCmd.Builder>)o;
